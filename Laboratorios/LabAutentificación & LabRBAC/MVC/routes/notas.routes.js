...
//Formato para rutas de notas:
// ruta: /notas
// isAuth: verifica que el usuario esté logueado
// hasPermission('clave_permiso'): verifica que el usuario tenga el permiso específico para esa acción
// controller: función que renderiza la lista de notas, etc. (ver controller)
